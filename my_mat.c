    ...
    for (int k = 0; k < 10; k++)
    {
        for (int i = 0; i < 10; i++)
        {
            ...
            {   
                if (matrix[i][j] > 0)
                {
                    if (matrix[i][k] > 0 && matrix[k][j] > 0 && matrix[i][j] > matrix[i][k] + matrix[k][j])
                    {
                ...
                for (int r = 0; r < j; r++)
                {
                    if (matrix[i][j] > 0)
                    {
                         if (matrix[i][r] > 0 && matrix[r][j] > 0 && matrix[i][j] > matrix[i][r] + matrix[r][j])
                        {
                            matrix[i][j] = matrix[i][r]+ matrix[r][j];
                            matrix[j][i] = matrix[i][r]+ matrix[r][j];
                        }
                    }else{
                         if (matrix[i][r] > 0 && matrix[r][j] > 0)
                        {
                            matrix[i][j] = matrix[i][r]+ matrix[r][j];
                            matrix[j][i] = matrix[i][r]+ matrix[r][j];
                        }
